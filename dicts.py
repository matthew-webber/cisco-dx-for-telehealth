xml_dict = dict(
    ...
    commands= dict(
        ...
        phonebook_search='<Command><Phonebook><Search><ContactType>$contact_type</ContactType><Recursive>True</Recursive><Limit>$limit</Limit><Offset>0</Offset>$search_str<PhonebookType>Local</PhonebookType><PhonebookId></PhonebookId></Search></Phonebook></Command>',
